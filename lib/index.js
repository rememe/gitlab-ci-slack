...
(function() {
  ...
  app.post('/webhook/slack/deploy', function(req, res) {
    ...
    if (project !== void 0) {
      return res.send({
        text: "Manage project at: <https://gitlab.com/" + project + "/environments|" + project + ">"
      });
    } else {
      return res.send({
  ...
  app.post('/', function(req, res) {
    var authorName, authorUsername, body, branch, color, data, environment, pipeline, pretext, project, projectName, projectUrl, status, success, text, title, value;
    body = req.body;
